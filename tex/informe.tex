...
\begin{figure}[H]
  ...
  \caption{Tasa de aciertos en función de número iteraciones del algoritmo QR}
...
De manera similar, notamos mejoras en la tasa de aciertos al reducir la cota de error $e$ empleada en el algoritmo QR para la aproximación de autovectores de la matriz de covarianza. La tasa de aciertos se estabiliza alrededor del 80\% para valores $e < *NUMERO*$. Ver figura \ref{tasas-vs-iteraciones}.
...
Identificamos la configuración $k = 40$, $e = *NUMERO*$, que arroja una tasa de aciertos de 82\%, como la configuración óptima para aplicaciones que requieren un uso eficiente del tiempo. Ver figuras \ref{tasas-vs-k} y \ref{tasas-vs-iteraciones}.
